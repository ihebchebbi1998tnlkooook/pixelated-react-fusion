...
const OrderSummary = ({
  ...
  const hasPersonalization = cartItems.some(item => 
    item.personalization && item.personalization !== '-' && item.personalization.trim() !== ''
  );
  ...
  // Add personalization total to final total
  const totalWithPersonalization = finalTotal + personalizationTotal;
    ...
    >
      <div className="bg-white rounded-lg shadow-sm p-6 sticky top-32 border border-gray-100">
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="border-t border-gray-100 pt-4">
            <div className="flex justify-between text-lg font-medium text-[#1A1F2C]">
              <span>Total</span>
              <span>{totalWithPersonalization.toFixed(2)} TND</span>
            </div>
        ...
        <PaymentButtons
          ...
          total={subtotal}
          shipping={shipping}
          finalTotal={totalWithPersonalization}
