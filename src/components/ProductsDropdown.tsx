...
const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    items: [
      { label: "Sucre de Dattes", href: "products", category: "sucre-dattes", translationKey: "navbar.date_sugar" }
    ]
  },
  {
    ...
    items: [
      { label: "Café de Dattes", href: "products", category: "cafe-dattes", translationKey: "navbar.date_coffee" }
    ]
  }
];
        ...
        <div className="absolute top-full left-0 mt-1 w-64 bg-white rounded-lg shadow-lg border border-gray-100 py-2 z-50">
          {MENU_ITEMS.map((item) => (
            <div 
              ...
              className="relative group"
              onMouseEnter={() => setActiveSubmenu(item.translationKey)}
            >
              {/* Main Category Item */}
              ...
              {activeSubmenu === item.translationKey && (
                <div 
