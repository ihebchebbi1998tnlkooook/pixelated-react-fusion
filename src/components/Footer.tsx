...
const Footer = () => {
  ...
  const handleWhatsAppContact = () => {
    window.open('https://wa.me/21629502656', '_blank');
  };
  ...
  return (
    <footer className="bg-white text-gray-800">
        ...
        <div className="mt-12 pt-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
          ...
          <p className="text-xs">
            Fait avec ❤️ en Tunisie {isIhebChebbi() ? (
              <>par <a href="#" target="_blank" rel="noopener noreferrer" className="font-bold hover:underline">HolaStudio</a></>
            ) : (
              <>par <a href="#" target="_blank" rel="noopener noreferrer" className="font-bold hover:underline">HolaStudio</a></>
            )}
          </p>
      ...
      <InfoModal
        ...
        content="Nous livrons dans toute la Tunisie sous 2-5 jours ouvrables. La livraison est gratuite pour toute commande supérieure à 299 DT. Pour les commandes internationales, le délai de livraison est de 5-10 jours ouvrables. Nous vous informerons par email dès que votre commande sera expédiée."
      />
