...
export const packContent: Record<string, PackContent> = {
  ...
  'Pack Mini Duo': {
    ...
    description: "Compact et élégant, le Pack Mini Duo est un cadeau idéal. Il inclut un porte carte en cuir raffiné et une ceinture sophistiquée. Ajoutez une gravure personnalisée pour une touche unique.",
    images: [
      "/Packduomini2.png"
    ],
    videoUrl: ""
